    ...
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
      <div className="border-b border-brand-border px-3 py-3 sm:px-5 sm:py-4">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h2 className="text-base font-bold text-foreground sm:text-lg">Checkout</h2>
      ...
      <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-3 py-3 sm:px-5 sm:py-4">
        {cart.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-brand-border bg-brand-gray/40 px-4 py-8 text-center sm:py-10">
            ...
            <p className="mt-2 text-sm font-medium text-foreground">Cart is empty</p>
            <p className="mt-1 text-xs text-muted">Search and add products to cart</p>
          </div>
        ) : (
                  ...
                  <div className="mt-2 flex items-center justify-between gap-2">
                    <div className="flex items-center rounded-lg border border-brand-border">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center text-sm font-semibold text-muted hover:bg-brand-gray"
                      >
                        −
                      </button>
                      ...
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center text-sm font-semibold text-muted hover:bg-brand-gray disabled:opacity-40"
                      >
                        +
                      </button>
                    </div>
        ...
        <div className="space-y-3 rounded-2xl border border-brand-border bg-brand-cream/40 p-4">
          ...
          <input
            ...
            className="w-full rounded-xl border border-brand-border bg-card px-3 py-2.5 text-sm outline-none focus:border-brand-orange"
          />
          <input
            type="tel"
            value={customerPhone}
          ...
          <textarea
            ...
            rows={2}
            className="w-full resize-none rounded-xl border border-brand-border bg-card px-3 py-2.5 text-sm outline-none focus:border-brand-orange"
          />
          <textarea
            value={notes}
      ...
      <div className="flex-shrink-0 border-t border-brand-border bg-card p-3 sm:p-5">
        <dl className="space-y-2 text-sm">
          ...
          <div className="flex justify-between border-t border-brand-border pt-2 text-base font-bold text-foreground">
            <dt>Total</dt>
