      ...
      <table className="w-full min-w-[1100px] border-collapse text-xs">
        ...
        <tbody>
          {rows.map((row, index) => (
            ...
            >
              <td
                className="sticky left-0 z-20 border-r border-brand-border bg-card px-3 py-1.5 text-muted group-hover:bg-brand-gray/20 shadow-[2px_0_4px_rgba(0,0,0,0.04)]"
                style={{ width: STICKY_INDEX_WIDTH, minWidth: STICKY_INDEX_WIDTH }}
              >
                {index + 1}
              </td>
              <td
                className="sticky z-20 border-r border-brand-border bg-card px-2 py-1 group-hover:bg-brand-gray/20 shadow-[2px_0_4px_rgba(0,0,0,0.04)]"
                style={{
                  left: STICKY_NAME_LEFT,
                  width: STICKY_NAME_WIDTH,
                  minWidth: STICKY_NAME_WIDTH,
