  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <button
        ...
        className="rounded-xl border border-blue-200 bg-blue-50 px-5 py-2.5 text-sm font-semibold text-blue-700 transition-colors hover:border-blue-300 hover:bg-blue-100"
      >
        Connect Sheet
      </button>
      ...
      {lastSheetUrl ? (
        <button
          ...
          className="rounded-xl border border-brand-border bg-white px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-brand-gray"
        >
          Open Last Sheet
        </button>
      ) : null}
