  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h2 className="text-xl font-bold text-foreground">Homepage Management</h2>
        ...
        {homepageSections.map((section) => (
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="rounded-full bg-brand-gray px-2.5 py-1 text-xs font-semibold text-muted">
